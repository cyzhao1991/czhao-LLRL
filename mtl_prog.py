...
model_name = '/disk/scratch/chenyang/new_Data/dm_control/stl/walker_s-1.0/w0.0g0.0/exp0/walker-iter1000.ckpt'
saver.restore(sess, model_name)
pre_learned_var_2 = sess.run(learned_var_list)
sess.close()
tf.reset_default_graph()
...
model_name = 'new_Data/dm_control/tl_prog/walker_s1.0/w0.0g0.0/exp0/walker-iter500.ckpt'
saver.restore(sess, model_name)
