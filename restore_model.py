...
model_file = './Data/dm_control/context_mtl/walker_walk/exp3/walker_walk-iter800.ckpt'
...
# num_of_paths = 10
# dir_name = 'Data/checkpoint/stl/walker2d_exp%i'%0
...
# 	learn_agent = TRPOagent(env, actor, baseline, sess, pms, [None], goal = goal)
...
# # learn_agent.pms.train_flags = False
# # # learn_agent..get_single_path
