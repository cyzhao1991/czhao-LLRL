...
class VanillaMtl(Agent):
	...
	def init_vars(self):
		...
		with tf.name_scope(self.pms.name_scope):
			...
			self.optimizer = tf.train.AdamOptimizer( learning_rate = .001, name = 'Adam')
			...
			# self.kl_beta = tf.constant(2., tf.float32)
