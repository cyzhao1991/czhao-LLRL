...
SPLIT_NUM = 5
NUM_OF_LATENT = 10
LAMBDA2_list = np.logspace(-2,1,40)
...
s_ITER = range(MAX_ITER/8, MAX_ITER/4) + range(MAX_ITER*3/8, MAX_ITER/2) + range(MAX_ITER*5/8, MAX_ITER*3/4) + range(MAX_ITER*7/8, MAX_ITER)
L_ITER = range(MAX_ITER/8) + range(MAX_ITER/4, MAX_ITER*3/8) + range(MAX_ITER/2, MAX_ITER*5/8) + range(MAX_ITER*3/4, MAX_ITER*7/8)
