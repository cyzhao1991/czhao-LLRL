...
class CartPoleTripleEnv(gym.Env):
	metadata = {
	...
	def _get_obs(self):
		...
		theta3 = self.j4.getAngle()
		theta3dot = self.j4.getAngleRate()
		return np.array([x, xdot, theta, thetadot, theta2, theta2dot, theta3, theta3dot])
